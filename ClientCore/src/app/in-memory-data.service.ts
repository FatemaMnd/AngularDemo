...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    let products: Product[] = [
        // Bakery
        { id: 1, categoryId: 1, title: 'Baguette', price: 1.5, isSpecial: false, imageL: 'http://placehold.it/1110x480', imageS: 'http://placehold.it/270x171', desc: 'Great eaten fresh from oven. Used to make sub sandwiches, etc.' },
        ...
        { id: 7, categoryId: 4, title: 'Ribs', price: 4.85, isSpecial: false, imageL: 'http://placehold.it/1110x480', imageS: 'http://placehold.it/270x171', desc: 'Pork ribs are a cut of pork popular in North American and Asian cuisines. ' },
